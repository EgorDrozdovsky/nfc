...
class PlanController extends Controller
{
    ...
    public function savePlan(Request $request)
    {
        ...
        $plan->save();
        alert()->success('New Plan Created Successfully!');
    ...
    public function updatePlan(Request $request)
    {
        ...
        Plan::where('plan_id', $request->plan_id)->update([
            ...
            'personalized_link' => $personalized_link, 'hide_branding' => $hide_branding, 'free_setup' => $free_setup, 'free_support' => $free_support, 'is_watermark_enabled' => $is_watermark_enabled
        ]);
        alert()->success('Plan Details Updated Successfully!');
