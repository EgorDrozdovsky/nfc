...
class SettingsController extends Controller
{
    ...
    public function updateTaxSetting(Request $request)
    {
        ...
        alert()->success('Invoice Setting Updated Successfully!');
    ...
    public function updateEmailSetting(Request $request)
    {
        ...
        alert()->success('Email Setting Updated Successfully!');
        return redirect()->route('admin.tax.setting');
    }
    ...
    public function clear()
    {
        ...
        alert()->success('Website Cache Cleared Successfully!');
    ...
    public function testEmail() {
        ...
        try {
            ...
            alert()->error('Email configuration wrong.');
            return redirect()->back();
        }
        if($mail == true) {
            alert()->success('Test mail send successfully.');
            return redirect()->back();
        }
    }
