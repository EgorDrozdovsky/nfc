...
class OfflineController extends Controller
{
    public function offlineCheckout(Request $request, $planId)
    {
        ...
        if ($config[31]->config_value == null) {
            alert()->error('No Bank Transfer details found!');
    ...
    public function markOfflinePayment(Request $request)
    {
        ...
        if ($plan_details == null) {
            ...
            $transaction->save();
            alert()->success('Bank transfer transaction pending now. Once, Transaction is done, will be implemented your plan by the admin.');
