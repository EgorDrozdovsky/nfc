                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="#"
                                            onclick="getOfflineTransaction('{{ $transaction->gobiz_transaction_id }}'); return false;">{{ __('Success') }}</a>
                                        @endif
                                        @if ($transaction->payment_status != "SUCCESS" && $transaction->payment_status != "FAILED")
                                        <a class="btn btn-primary btn-sm"
                                            href="{{ route('admin.offline.trans.status', ['id' => $transaction->gobiz_transaction_id, 'status' => 'FAILED'])}}">{{ __('Failed') }}</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
