                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $details['to_billing_name'] }},</h1>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ route('user.view.invoice', $details['gobiz_transaction_id']) }}"
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <h3>{{ __('Invoice Number :') }} {{ $details['invoice_id'] }}</h3>
                                                    </td>
                                                    <td>
                                                        <h3 class="align-right">{{ __('Invoice Date :') }} {{ $details['invoice_date'] }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right" width="20%"
                                                                    class="purchase_item"><span
                                                                        class="f-fallback">{{ $details['invoice_currency'] }} {{ $details['invoice_amount'] }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <p>{{ __('If you have any questions about this invoice, simply reply to this email
                                                or reach out to our') }} <a
                                                    href="mailto:{{ $details['from_billing_email'] }}">{{ __('support team') }}</a> {{ __('for help.') }}
                                            </p>
                                            <p>Cheers,
                                                <br>The {{ $details['from_billing_name'] }} Team</p>
                                            <!-- Sub copy -->
                                            <table class="body-sub" role="presentation">
                                                <tr>
                                                    <td>
                                                        <p class="f-fallback sub">{{ $details['email_footer'] }}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; 2021
                                            {{ $details['from_billing_name'] }}. All rights
                                            reserved.</p>
