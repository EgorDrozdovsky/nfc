                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        @for ($i = 0; $i < count($products); $i++) <div class='row' id="{{ $i }}">
                                            ...
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                                    ...
                                                    <textarea class='form-control' name='product_subtitle[]'
                                                        ...
                                                        placeholder='{{ __('Product Sub Title') }}...'>{{ $products[$i]->product_subtitle }}</textarea>
                                                </div>
                                            </div>
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'><label
                                                    ...
                                                    <input type='number' class='form-control' name='regular_price[]'
                                                        ...
                                                        value="{{ $products[$i]->regular_price }}" min='1' step='.01'>
                                                </div>
                                            </div>
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                            ...
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                                    ...
                                                    <a href='#' class='btn mt-3 btn-danger btn-sm'
                                                        onclick='removeProduct("+id+")'>Remove</a>
                                                </div>
                                            </div>
                                    </div>
                                    @endfor
