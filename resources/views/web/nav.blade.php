        ...
        <ul
            ...
            <li>
                ...
                <a class="text-sm font-bold hover:text-dark text-dark"
                    href="#how-it-works" >{{ __('How it works?') }}</a></li>
                @else
                <a class="text-sm font-bold hover:text-dark text-dark"
            ...
            <li>
                ...
                @else
                <a class="text-sm font-bold hover:text-dark text-dark" href="{{ route('home-locale') }}#features">{{ __('Features') }}</a>
                @endif
            </li>
            ...
            <li>
                ...
                @else
                <a class="text-sm font-bold hover:text-dark text-dark" href="{{ route('home-locale') }}#pricing">{{ __('Pricing') }}</a>
                @endif
            </li>
            <li class="text-gray-800">
                <svg class="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24"
        ...
        <nav
            ...
            <div class="mt-auto">
                ...
                <div class="text-center"><a class="inline-block px-1" href="{{ $supportPage[1]->section_content }}" target="_blank"><img
                            src="{{ asset('frontend/assets/social/facebook.svg') }}" alt=""></a><a
